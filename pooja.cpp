...
{
    QMessageBox::information(this,"Poojasrinivasan212218108041","This is information");
}

void Dialog::on_pushButton_2_clicked()
{
    QMessageBox::StandardButton reply;
      reply = QMessageBox::question(this, "Pooja", "Do you play football?", QMessageBox::Yes|QMessageBox::No);
